...
{
    // vEmployee
    internal class HumanResources_VEmployeeConfiguration : EntityTypeConfiguration<HumanResources_VEmployee>
    {
        public HumanResources_VEmployeeConfiguration(string schema = "HumanResources")
        {
