...
{
    // PhoneNumberType
    internal class Person_PhoneNumberTypeConfiguration : EntityTypeConfiguration<Person_PhoneNumberType>
    {
        public Person_PhoneNumberTypeConfiguration(string schema = "Person")
        {
