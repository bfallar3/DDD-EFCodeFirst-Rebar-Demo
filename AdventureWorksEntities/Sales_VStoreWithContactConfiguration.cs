...
{
    // vStoreWithContacts
    internal class Sales_VStoreWithContactConfiguration : EntityTypeConfiguration<Sales_VStoreWithContact>
    {
        public Sales_VStoreWithContactConfiguration(string schema = "Sales")
        {
